...
namespace _3DMAX
{
    public class CustomWindow : Window
    {
        ...
        public CustomWindow()  
        {  
            mWindowResouce.Source = new Uri("./Theme/CustomWindowStyle.xaml", UriKind.Relative);  
        ...
        {  
            ...
            {  
                ...
                case BackGroundType.Black:
                    backBorder.Style = (Style)mWindowResouce["BackStyleBlack"];
                    headBorder.Style = (Style)mWindowResouce["HeadStyleBlack"];
                    break; 
                default:
                    backBorder.Style = (Style)mWindowResouce["BackStyleBlack"];
                    headBorder.Style = (Style)mWindowResouce["HeadStyleBlack"];  
